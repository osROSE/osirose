...
CPacket::CPacket(unsigned short mycommand, unsigned short mysize,
                 unsigned short myunused) {
	Command = mycommand;
	Size = mysize;
	Unused = myunused;
}
...
void CPacket::StartPacket(unsigned short mycommand, unsigned short mysize,
                          unsigned short myunused) {
	Command = mycommand;
	Size = mysize;
	Unused = myunused;
